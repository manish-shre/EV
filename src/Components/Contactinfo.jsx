...
const Contactinfo = () => {
  return (
    // <div className="grid grid-cols-1 md:grid-cols-2 items-center gap-6"></div>
    <div className="flex flex-col md:flex-row justify-between items-center gap-20 p-6 md:p-25 py-15 md:px-45">
      {/* Left Content */}
      <div className="md:w-[50%] space-y-6">
        ...
        <h3 className="text-[28px] font-medium text-[#333333]">
        ...
        {/* Contact Information */}
          ...
          <h4 className="text-[28px] font-medium text-[#333333]">Get in Touch</h4>
      ...
      {/* Contact Form */}
      <div className="bg-white shadow-md rounded-[15px] p-8 w-full md:w-1/3">
        <h3 className="text-[28px] font-medium text-[#004C83] mb-4">Talk to Our Expert</h3>
